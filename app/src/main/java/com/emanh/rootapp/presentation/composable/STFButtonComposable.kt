...
fun ButtonPrimaryPreview() {
    E2MP3Theme {
        STFButton(modifier = Modifier.fillMaxWidth().padding(horizontal = 16.dp), text = "Button", type = STFButtonType.Primary, onClick = {})
    }
}
...
fun ButtonSecondaryPreview() {
    E2MP3Theme {
        STFButton(modifier = Modifier.fillMaxWidth().padding(horizontal = 16.dp), text = "Button", type = STFButtonType.Secondary, onClick = {})
    }
}